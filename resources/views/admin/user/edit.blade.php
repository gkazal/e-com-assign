                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class=" p-5 " method="post" action="{{ route('admin.user.update', $target->id ) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="user_type" aria-label="Default select example">
                                        <option value="admin" {{ $target->user_type == 'admin' ? 'selected' : '' }} >Admin</option>
                                        <option value="user" {{ $target->user_type == 'user' ? 'selected' : '' }}>User</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" class="form-control" id="phone" value="{{ $target->phone }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ $target->email }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="address" class="form-control" id="address" value="{{ $target->address }}">
