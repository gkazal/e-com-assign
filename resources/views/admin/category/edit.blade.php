                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class=" p-5 " method="post" action="{{ route('admin.category.update', $target->id ) }}"
                                enctype="multipart/form-data">
                                @csrf                               

                                <div class="mb-3">
                                    <label for="name" class="form-label">Name</label>
                                    <input type="text" name="category_name" class="form-control" id="name" value="{{ $target->category_name }}">
